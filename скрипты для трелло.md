...
from people.team t
         ...
         inner join (select *
                     from pm_trace.pm_trace_status ts
         ...
         left join pm_trace.pm_trace_task task on task.status_id = ts.id and task.id is not null
         ...
         left join pm_trace.pm_trace_task_participants pa on task.id = pa.task_id
