...
from (select distinct tu.userID,
                      t.title  as team,
                      t.id     as teamID,
                      tu.role  as role,
                      lc.id    as contextID,
      ...
      where lc.id in (142, 146, 132, 130, 153, 135, 145, 139, 166, 140, 167, 144, 147, 131, 175)) team_users
...
where ui.leaderID not in (285904, 120408, 56129, 253433, 79918, 66276, 12274, 310842, 326040, 292928, 62575, 301300,
